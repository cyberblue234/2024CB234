...
{
    return {units::meters_per_second_t{GetDriveVelocity()}, units::radian_t{GetCanCoderDistance()}};
}

frc::SwerveModulePosition SwerveModule::GetPosition()
{
    return {units::meter_t{GetEncoderDistance()}, units::radian_t{GetCanCoderDistance()}};
}
